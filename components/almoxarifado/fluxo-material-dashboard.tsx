...
import { Package, TrendingUp, TrendingDown, Warehouse, Layers3 } from "lucide-react"
...
export function FluxoMaterialDashboard({ data, entradas, saidas }: FluxoMaterialDashboardProps) {
