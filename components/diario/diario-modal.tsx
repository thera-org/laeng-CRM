        ...
        <div className="overflow-y-auto px-6 py-6 space-y-6 flex-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-1 relative md:col-span-2">
                  ...
                  {m.loadingClientes ? (
                    ...
                    m.filteredClientes.map((c) => (
                      <button
                        ...
                        className="w-full px-4 py-2 text-left text-sm hover:bg-yellow-50 border-b last:border-b-0"
                      >
              ...
              {m.selectedCliente && (
                <div className="bg-yellow-50 border border-yellow-200 p-3 rounded-md flex justify-between items-center text-yellow-900 mt-1">
                  <div>
