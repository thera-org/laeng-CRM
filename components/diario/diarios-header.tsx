...
import { Search, ClipboardList, Calendar, RotateCcw, Plus, type LucideIcon } from "lucide-react"
        ...
        <div className="bg-gray-800/30 rounded-lg p-3 border border-gray-700 space-y-3">
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <div className="flex gap-2 w-full sm:w-auto">
              <Button
                onClick={onNew}
                className="h-10 bg-[#F5C800] sm:w-[150px] hover:bg-[#F5C800]/90 text-[#1E1E1E] font-bold px-4 shadow-sm">
